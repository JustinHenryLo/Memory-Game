...
public class Third extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        keys.add("1");keys.add("2");keys.add("3");keys.add("4");
        keys.add("5");keys.add("6");keys.add("7");keys.add("8");
        keys.add("9");keys.add("10");keys.add("11");keys.add("12");
        ...
        ids.add(R.id.buttonN);ids.add(R.id.buttonO);ids.add(R.id.buttonP);ids.add(R.id.buttonQ);
        ids.add(R.id.buttonR);ids.add(R.id.buttonS);ids.add(R.id.buttonT);ids.add(R.id.buttonU);
        ids.add(R.id.buttonV);ids.add(R.id.buttonW);ids.add(R.id.buttonX);ids.add(R.id.buttonY);
